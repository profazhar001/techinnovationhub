<?php
  ...
  <head>  
    ...
    animationEnabled: true,
    title: {
        text: "Computer Science in Associate's Degrees awarded data by field: 2000-2019 (National)"
    },
    axisY: {
        ...
        <nav>
            <ul class="Topbar">
                ...
                <li class="menu-items">
                    ...
                    <a href="index2.html"><i class="fa-solid fa-rocket"></i>Career Readiness</a>
