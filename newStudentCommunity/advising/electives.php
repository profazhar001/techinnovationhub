...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.13.0/themes/base/jquery-ui.css">
    ...
    <div class="container1">
        ...
        <div class="search-container">
            ...
            <input type="text" name="search" id="search-input" placeholder="Enter your Elective course name" autocomplete="off" onkeyup="searchCourses(this.value)">
...
require_once "config2.php";
            ...
            UNION
            SELECT id, course_name, credit, description, 'World Cultures and Global Issues' AS table_name FROM `World Cultures and Global Issues`
            WHERE course_name LIKE '%" . $search . "%'ß
            UNION
            SELECT id, course_name, credit, description, 'Program Electives' AS table_name FROM `Program Electives`
            WHERE course_name LIKE '%" . $search . "%'";
...
$(document).ready(function() {
  const courseNames = [
'ACL 200 - Literacy Practices: Birth through Adolescence',
...
'ACR 195 - Literacy, Development, and Social Justice',
'AFN 121 - History of African Civilization',
'AFN 122 - Africa 1500 to Present',
'AFN 128 - Black Women in the Americas and the Caribbean',
'ANT 100 - Introduction to Anthropology',
'ANT 200 - Peoples & Cultures of Latin America and the Caribbean',
'ASN 111 - Chinese Culture and Heritage',
'COM 255 - Intercultural Communication',
'GEO 100 - Introduction to Human Geography',
'LAT 130 - History of Latin America',
...
'MES 140 - Introduction to the Moving Image',
'MES 160 - World History of Animation',
'POL 111 - Political Economy of Technoscience',
'TRS 231 - Introduction to Translation and Interpretation Theory',
'TRS 233 - Spanish Translation & Interpretation for Healthcare',
'CIS 345 - Telecommunication Networks I',
'CIS 359 - Information Assurance',
'CIS 362 - Cloud Computing',
'CIS 364 - Mobile Device Programming',
'CIS 385 - Web Programming I',
'CIS 395 - Database Systems I',
'CSC 103 - Introduction to Data Analytics',
